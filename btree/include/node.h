...
static const uint8_t LEAF_NODE_NUM_CELLS_SIZE =
    sizeof(uint32_t); // number of KV pairs
static const uint8_t LEAF_NODE_NUM_CELLS_OFFSET = COMMON_NODE_HEADER_SIZE;
static const uint8_t LEAF_NODE_HEADER_SIZE =
...
static const uint32_t LEAD_NODE_SPACE_FOR_CELLS =
    PAGE_SIZE - LEAF_NODE_HEADER_SIZE;
static const uint32_t LEAF_NODE_MAX_CELLS =
    LEAD_NODE_SPACE_FOR_CELLS / LEAF_NODE_CELL_SIZE;
